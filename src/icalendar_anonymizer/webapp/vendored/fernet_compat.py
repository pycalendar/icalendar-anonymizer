# SPDX-FileCopyrightText: 2016 Oz N Tiram
# SPDX-License-Identifier: MIT
#
# Vendored from https://github.com/oz123/python-fernet (MIT License)
# Pure Python Fernet implementation for Cloudflare Workers compatibility
# ruff: noqa: N818, B904
...
from icalendar_anonymizer.webapp.vendored.pyaes import (
    AESModeOfOperationCBC,
    Decrypter,
    Encrypter,
)

__all__ = ["Fernet", "InvalidSignature", "InvalidToken"]
_MAX_CLOCK_SKEW = 60
